    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-zinc-950 border border-zinc-900 p-8 rounded-sm space-y-8 shadow-2xl">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-black uppercase tracking-tight text-white">SIGN IN TO CINEMA</h2>
          <p className="text-xs text-zinc-500 font-bold uppercase">Welcome back to your cinematic portal</p>
        </div>
